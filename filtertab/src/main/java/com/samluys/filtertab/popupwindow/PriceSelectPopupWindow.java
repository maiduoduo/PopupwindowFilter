...
public class PriceSelectPopupWindow extends BasePopupWindow {
    ...
    public View initView() {
        ...
        btn_price_confirm = (Button) rootView.findViewById(R.id.btn_price_confirm);
        et_min_price = (EditText) rootView.findViewById(R.id.et_min_price);
        et_max_price = (EditText) rootView.findViewById(R.id.et_max_price);
        ll_input = (ConstraintLayout) rootView.findViewById(R.id.bottom);
        // toolbar高度
